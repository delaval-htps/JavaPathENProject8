...
public class TourGuideService {
  ...
  /**
   * @return the gpsUtilService
   */
  public GpsUtilService getGpsUtilService() {
    return gpsUtilService;
  }

  /**
   * @return the rewardsService
   */
  ...
  public void trackUserLocation(User user, UserService userService, RewardsService rewardsService) {
    // VisitedLocation visitedLocation = gpsUtil.getUserLocation(user.getUserId());
    // user.addToVisitedLocations(visitedLocation);
    // rewardsService.calculateRewards(user);
    // return visitedLocation;

    gpsUtilService.getLocation(user, userService, rewardsService);
